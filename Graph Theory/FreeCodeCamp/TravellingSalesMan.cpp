...
/*Given a complete graph with weighted edges as an adjacency  matrix what is
the hamiltonian cycle(path that visits every node once) of minimum cost*/
// Brute Force takes O(n!) trying all possible permutations
void solve(){
